...
// Import the new BookRow component
import BookRow from './BookRow'; // Adjust the import path if necessary
...
const BookDetailPage = () => {
  ...
  const handleLanguageChange = (language) => {
    ...
    // Add additional logic for loading content in the selected language, if needed
  };
  ...
  return (
    <div className="book-detail-container">
      ...
      {/* Include the BookRow component here */}
      <BookRow />
    </div>
  );
};
